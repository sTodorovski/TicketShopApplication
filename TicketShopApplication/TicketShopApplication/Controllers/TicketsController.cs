...
namespace TicketShopApplication.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,Movie,Poster,Description,Genre,Price,Rating,Date")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,Movie,Poster,Description,Genre,Price,Rating,Date")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
